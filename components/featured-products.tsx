            ...
            <div key={i} className="group relative">
              ...
              <div className="relative aspect-square overflow-hidden rounded-lg bg-velour-cream">
                ...
                <div className="absolute inset-0 flex items-end justify-center bg-velour-plum/0 pb-4 opacity-0 transition-all duration-300 group-hover:bg-velour-plum/20 group-hover:opacity-100">
                  <button className="flex items-center gap-2 rounded-sm bg-velour-plum px-4 py-2 text-xs font-medium text-velour-ivory transition-colors hover:bg-velour-plum-light">
                ...
                <button
                  ...
                  className="absolute right-3 top-3 rounded-full bg-card/80 p-1.5 text-muted-foreground transition-colors hover:text-velour-plum"
                >
