        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="relative hidden text-velour-ivory/80 transition-colors hover:text-velour-gold sm:block"
            >
          ...
          <nav className="border-t border-velour-ivory/10 bg-velour-plum px-4 pb-6 pt-4 lg:hidden">
            <div className="flex flex-col gap-4">
              ...
              <button
                ...
                className="flex items-center gap-2 font-serif text-lg text-velour-ivory/90 transition-colors hover:text-velour-gold sm:hidden"
              >
                <Heart className="h-5 w-5" />
                Wishlist
                {wishlistCount > 0 && (
                  <span className="flex h-5 w-5 items-center justify-center rounded-full bg-velour-gold text-xs font-semibold text-velour-plum">
                    {wishlistCount}
                  </span>
                )}
              </button>
